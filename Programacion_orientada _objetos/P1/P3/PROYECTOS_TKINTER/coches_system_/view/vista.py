...
class View:
    ...
    def agregar_auto(ventana,marca,color,modelo,velocidad,caballaje,plazas,tipo):
        ...
        btn_guardar = Button(ventana,text="Guardar",justify=CENTER, command=lambda:controlador.Controlador.insertar_auto(entry_marca.get(), entry_color.get(), entry_modelo.get(), entry_velocidad.get(), entry_caballaje.get(), entry_plazas.get()))
    ...
    def consultar_autos(ventana,id,tipo):
        ...
        filas=""
        registros=controlador.Controlador.consultar_autos()
        if len(registros)>0:
            num_notas=1
    ...
    def borrar_auto(ventana,id,tipo):
        ...
        btn_borrar = Button(ventana,text="Borrar",justify=CENTER, command=lambda:controlador.Controlador.eliminar_auto( entry_id,entry_id.get()))
        btn_borrar.pack(pady=10)
        btn_volver = Button(ventana,text="Volver",justify=CENTER, command=lambda:View.menu_acciones(ventana, tipo))
        btn_volver.pack(pady=10)
