...
class Vistas:
    ...
    def eliminar(self,ventana):
        ...
        boton_eliminar=Button(ventana, text="Eliminar", command=lambda: self.eliminarYBloquear(id,entry_id))
        boton_eliminar.pack()

        boton_volver=Button(ventana, text="Volver", command=lambda: self.interfaz(ventana))
        boton_volver.pack()
    
    def eliminarYBloquear(self,id_var,entry_id):
        funciones.Controladores.eliminar(id_var.get())
