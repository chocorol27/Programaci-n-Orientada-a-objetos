...
from coches import Coches, Camionetas
coche=Coches("VW","Blanco","2020",220,200,5)
print(coche.marca, coche.acelerar())

camioneta=Camionetas("Chevrolet","Rojo","2023",300,400,7,"4x4",False)
print(camioneta.marca, camioneta.acelerar(), camioneta.traccion)
...
for i in range(0,num_coches):
    ...
    velocidad=int(input("ingresBlancoaZ el modelo")).upper()
